...
# ipv4 and ipv6 are both internet protocols. In computer network it is numerical address assign to each computer which uses the IP for communication

# The IPv4 uses 32 bit address scheme so total combinations 2^32 addresses are there.
# some examples are : 127.255.255.255, 192.168.56.1, 192.168.43.92, 12.244.233.165  etc.

# The ipv4 patterns regex is given below
ipv4_pattern = r"^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$" 

# To fulfill the need of more address ipv6 come very efficient scheme. It uses 128-bit address, 
# like: 2001:0db8:0000:0000:0000:ff00:0042:7879, 2001:db8:85a3:8d3:1319:8a2e:370:7348
# 2001:db8:85a3:8d3:1319:8a2e:370:7348, 2001:db8:85a3:8d3:1319:8a2e:370:7348 etc.

# The regex for identifying ipv6 is given below 
